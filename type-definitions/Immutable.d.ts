...
export module SortedMap {
   ...
   * ```
   */
  export function SortedMap<K, V>(collection?: Iterable<[K, V]>,
    comparator?: (a: K, b: K) => number,
    options?: Object): SortedMap<K, V>;
  export function SortedMap<T>(collection: Iterable<Iterable<T>>,
    comparator?: (a: T, b: T) => number,
    options?: Object): SortedMap<T, T>;
  export function SortedMap<V>(obj: {[key: string]: V},
    comparator?: (a: string, b: string) => number,
    options?: Object): SortedMap<string, V>;
  ...
  export interface Collection<K, V> extends ValueObject {
     ...
     * provided for convenience and to allow for chained expressions.
     */
    toSortedMap(comparator?: (a: K, b: K) => number, options?: Object): SortedMap<K, V>;
     ...
     * for convenience and to allow for chained expressions.
     */
    toSortedSet(comparator?: (a: V, b: V) => number, options?: Object): SortedSet<V>;
    ...
    */
    ...
    /**
     * Like `partialSort`, but also accepts a `comparatorValueMapper` which allows for
     * sorting by more sophisticated means:
     *
